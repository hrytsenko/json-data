...
public final class JsonBean extends JsonEntity<JsonBean> {
  ...
  @Override
  public <R extends JsonEntity<R>> R getEntityOrDefault(String path, Supplier<R> supplier,
      R defaultValue) {
  ...
  @Override
  public <R extends JsonEntity<R>> List<R> getEntitiesOrDefault(String path, Supplier<R> supplier,
      List<R> defaultValue) {
