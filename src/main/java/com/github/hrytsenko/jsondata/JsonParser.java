...
public class JsonParser {
   ...
   *
   * @param json     the input JSON string.
   * @param supplier the supplier for the output JSON entity. Use a default constructor to create
   *                 the supplier.
   ...
   *
   * @param json     the input JSON string.
   * @param supplier the supplier for output JSON entities. Use a default constructor to create the
   *                 supplier.
   * @param <R>      the type of the output JSON entity.
   * @return the output list of JSON entities.
   * @throws JsonParserException if the conversion is failed.
   */
  public static <R extends JsonEntity<R>> List<R> stringToEntities(String json,
      Supplier<R> supplier) {
   ...
   * @throws JsonParserException if the conversion is failed.
   */
  public static <R extends JsonEntity<R>> List<R> listToEntities(List<Map<String, ?>> json,
      Supplier<R> supplier) {
    return json.stream()
   ...
   */
  public static <R extends JsonEntity<R>> Function<Map<String, ?>, R> fromMapTo(
      Supplier<R> supplier) {
   ...
   * @return the helper function.
   */
  public static <R extends JsonEntity<R>> Function<JsonEntity<?>, R> fromEntityTo(
      Supplier<R> supplier) {
